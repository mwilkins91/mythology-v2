...
public class Items extends TableImpl<ItemsRecord> {
    ...
    private static final long serialVersionUID = -1684025235;

    /**
     * The reference instance of <code>myth.items</code>
     */
    ...
    /**
     * The column <code>myth.items.description</code>.
     */
    public final TableField<ItemsRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>myth.items.owner_id</code>.
     */
    public final TableField<ItemsRecord, Integer> OWNER_ID = createField("owner_id", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>myth.items.creator_id</code>.
     */
    public final TableField<ItemsRecord, Integer> CREATOR_ID = createField("creator_id", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * Create a <code>myth.items</code> table reference
     */
    public Items() {
    ...
    /**
     * Create an aliased <code>myth.items</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ITEMS_CREATOR_ID, Indexes.ITEMS_OWNER_ID, Indexes.ITEMS_PRIMARY);
    }
    ...
    public List<ForeignKey<ItemsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ItemsRecord, ?>>asList(Keys.ITEMS_IBFK_1, Keys.ITEMS_IBFK_2);
    }

    public Characters itemsIbfk_1() {
        return new Characters(this, Keys.ITEMS_IBFK_1);
    }

    public Characters itemsIbfk_2() {
        return new Characters(this, Keys.ITEMS_IBFK_2);
    }
